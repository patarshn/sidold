        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <!-- Card Header - Dropdown -->
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Pengajuan Kematian</h6>
              <div>
            ...
            <div class="card-body">
              <div class="table-responsive">
               <form method="POST" id="formdelete" action="/kematian/destroy">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  foreach ($kematian as $k): ?>
                    <tr>
                    <td>
                        <input type="checkbox" name="rowdelete[]" value="<?=$k->id_form_kematian?>" class="rowdelete">
                        <?=$count++;?>
                      </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" onclick="store(base_url+'admin/kematian/destroy','#formdelete')">Delete</button>
