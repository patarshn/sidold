...
<div class="container mt-3">
    <div class="row" style="margin-left:0; margin-right:0;">
        <div class="col-lg-8 col-12 konten-form">
            ...
            <form method="POST" id="form" action="<?=base_url('form_hibah/store')?>">
                <h3>Form Keterangan Hibah</h3>
                <h5 style="margin-top:20px;">Penanggung Jawab</h5>
                <div class="form-row">
                    <div class="col-lg-12">
                        <label for="nik">NIK</label>
                        <input type="text" name="nik1" class="form-control" placeholder="NIK">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-12">
                        <label for="barang_hibah">Barang Hibah</label>
                        <input type="text" name="brg_hibah" class="form-control" placeholder="Barang Hibah">
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control" placeholder="Nominal Jual Beli">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="uk_timur">Ukuran Sebelah Timur</label>
                        <input type="text" name="u_timur" class="form-control" placeholder="Ukuran Sebelah Timur">
                    </div>
                    <div class="col-lg-6">
                        <label for="uk_barat">Ukuran Sebelah Barat</label>
                        <input type="text" name="u_barat" class="form-control" placeholder="Ukuran Sebelah Barat">
                    </div>
                    <div class="col-lg-6">
                        <label for="uk_selatan">Ukuran Sebelah Selatan</label>
                        <input type="text" name="u_selatan" class="form-control" placeholder="Ukuran Sebelah Selatan">
                    </div>
                    <div class="col-lg-6">
                        <label for="uk_utara">Ukuran Sebelah Utara</label>
                        <input type="text" name="u_utara" class="form-control" placeholder="Ukuran Sebelah Utara">
                    </div>
                </div>
            ...
            <div class="d-flex">
            <button type="button" class="btn btn-primary active-button align-self-center" onclick="store(base_url+'form_hibah/store','#form')">Simpan</button>
